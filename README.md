...
- 本拡張機能は**株式会社ドワンゴおよびニコニコ動画公式とは一切関係のない、個人開発の非公式ツール**です
- ニコニコ動画の仕様変更や利用規約の変更により、予告なく動作しなくなる場合があります
- 本拡張機能の利用によって生じたいかなる損害についても、開発者は責任を負いません
- ご利用の際はニコニコ動画の利用規約をご確認ください
...
- ニコるの状態は拡張機能とニコニコのコメントリスト間で**自動同期されません**。ページの更新（リロード）で最新状態に同期されます
